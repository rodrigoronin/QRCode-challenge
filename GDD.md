...
**Plataformas Alvo:** PC com versão de testes no browser (Windows/Linux), com escalabilidade futura para consoles
...
3. **Progressão e Customização** – crescimento via atributos, equipamentos, skills e habilidades (sem classes fixas inicialmente).
...
```text
[CIDADE/BASE] → [PREPARAÇÃO] → [EXPLORAR MAPA/DUNGEON/TORRE] → [COMBATE & FARM / BOSS] → [RETORNO À BASE]
```
...
1. **Cidade/Base:**
   ...
   - Comprar suprimentos, poções e forjar/melhorar equipamentos.
...
2. **Dungeon/Torre:**
   ...
   - Cada sala/andar aumenta a dificuldade e qualidade do loot.
   - O jogador pode sair a qualquer momento, mas não recebe a recompensa da dungeon.
   - Caso morra o jogador perder os drops e recebe apenas a experiência já adquirida.

3. **Combate:**

   - **Movimentação livre 8 direções (talvez 4 no MVP).**
   - **Ataques básicos + cooldowns curtos.**
...
| **Cajados**        | Longo   | Lento      | INT/WIS       | Mágico    |
